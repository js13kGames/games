...
function Joystick(){this.wellSize=100;this.dotSize=40;this.pos=new V;this.disabled=!1;this.reset();this._dotR2=this.dotSize*this.dotSize;this._dotCan=preDraw(this._drawDot.bind(this));this._wellCan=preDraw(this._drawWell.bind(this));can.addEventListener("touchstart",this._touchStart.bind(this));can.addEventListener("touchmove",this._touchMove.bind(this));can.addEventListener("touchend",this._touchEnd.bind(this));can.addEventListener("touchcancel",this._touchEnd.bind(this));can.addEventListener("touchleave",
...
!b.disabled&&b._start(V.fromTouch(a))&&(b._id=a.identifier)})},_touchMove(a){if(this.state===STICK_ENGAGED){var b=this;forEach(a.changedTouches,(a)=>{a.identifier===b._id&&b._move(V.fromTouch(a))})}},_touchEnd(a){if(this.state===STICK_ENGAGED){var b=this;forEach(a.changedTouches,(a)=>{a.identifier===b._id&&b._release()})}},_mouseUp(a){this._id===a.button&&(this._id=null,this._release())},_mouseDown(a){this.state!==STICK_ENGAGED&&this._start(V.fromMouse(a))&&(this._id=a.button)},_mouseMove(a){this._id===
a.button&&this._move(V.fromMouse(a))},_release(){this.state=STICK_RESETTING;hero.impulse(this.dot.i());this._lf=0;this.direction=this.direction===DIR_LEFT?DIR_RIGHT:DIR_LEFT;tutorial&&tutorial.touchUp()},_drawDot(a,b){var d=this.dotSize;b.height=b.width=2*d+14;a.fillStyle="#55e";a.shadowBlur=8;a.lineWidth=6;a.shadowColor="#33a";var e=d+7;a.beginPath();a.arc(e,e,d,0,2*Math.PI);a.fill()},_drawWell(a,b){var d=this.wellSize;b.width=b.height=2*d+18;a.fillStyle="#7f7";a.strokeStyle="#5e5";a.shadowBlur=
10;a.lineWidth=8;a.shadowColor="#3a3";var e=this.wellSize+9;a.beginPath();a.arc(e,e,d,Math.PI/2,-Math.PI/2);a.closePath();a.stroke();a.globalAlpha=.7;a.fill()}};
